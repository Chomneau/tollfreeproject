          ...
          <section class="wrapper">            
              ...
              <div class="inner contact">
                  ...
                  <div class="contact-form">
                      <!-- Form -->
                      <form id="contact-us" method="post" action="../insert_function.php">
                          <div class="col-xs-6 wow animated slideInLeft" data-wow-delay=".5s">
                              <div class="col-xs-12 wow animated slideInRight" data-wow-delay=".5s">
                                  <!-- Name -->
                                  <input type="text" name="title_en" id="name" required="required" class="form" placeholder="Title" />
                                  <!-- Message -->
                                  <textarea name="des_en" id="message" class="form textarea"  placeholder="Description"></textarea>
                          ...
                          <div class="col-xs-6 wow animated slideInRight" data-wow-delay=".5s">
                              <!-- ចំណងជើង -->
                              <input type="text" name="title_kh" id="name" required="required" class="form" placeholder="ចំណងជើង" />
                              <!-- ព័ត៌មាន​លំអិត សូម​សរសេរ​នៅ​ទីនេះ -->
                              <textarea name="des_kh" id="message" class="form textarea"  placeholder="ព័ត៌មាន​លំអិត សូម​សរសេរ​នៅ​ទីនេះ "></textarea>
                          </div><!-- End Right Inputs -->
