    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li><i class="fa fa-id-card" aria-hidden="true"></i> <strong>ALL NEWS</strong>  <i class="fa fa-angle-right" aria-hidden="true"></i></li>
                    </ol>
                </div>
            </div>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo substr($row['en_about'],0, 30) ?></td>
                                <td style="font-family: 'Content';"><?php echo substr($row['kh_about'], 0 , 30) ?></td>
                                <td><?php echo substr($row['create_date'],0,10) ?></td>

                                <td>
                                    <?php echo "<a href=footer_edit_form.php?id=". $row['id']." ><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i> Edit</a>" ?>
<!--                                    --><?php //echo "<a href=footer_delete.php?id=". $row['id']." onClick=\"return confirm('Are you sure you want to delete?')\" ><i class=\"fa fa-times\" aria-hidden=\"true\"></i> Delete</a>" ?>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                            </tr>
