    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li><i class="fa fa-id-card" aria-hidden="true"></i> <strong>View all users</strong>  <i class="fa fa-angle-right" aria-hidden="true"></i></li>
                    </ol>
                </div>
            </div>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th><i class="fa fa-unlock-alt" aria-hidden="true"></i> user_role</th>
                                <th><i class="fa fa-calendar" aria-hidden="true"></i> create_date</th>
                                <th><i class="fa fa-cogs" aria-hidden="true"></i> action</th>
                            </tr>
                            <tr>
                                <?php
                                include "../include/connection.php";
                                $select = "SELECT * FROM tbl_users ORDER BY id ASC";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="user_delete.php?id=<?php echo $row['id']; ?>" title="click for delete" onclick="return confirm('Are you sure to delete ?')"><i class="fa fa-times" aria-hidden="true"></i> Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
