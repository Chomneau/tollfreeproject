...
<main class="cd-main-content">
	...
	<div class="container">
		<div class="row">
			...
			$query="select * from tbl_company WHERE com_category = '".$_GET['category']."'";
					...
					<div class="company-contact col-sm-4 col-md-4 col-xs-12">
						...
						<div class="title col-md-9 col-xs-8">
							<ul class="list-item">
								...
								<li><h5><?php echo $row['company_name'] ?></h5></li>
								...
								<li class="phone"><i class="fa fa-phone" aria-hidden="true"></i>
									<a href="tel:<?php echo $row['com_phone'] ?>"> <?php echo $row['com_phone'] ?></a>
								</li>
								<li class="phone"><i class="fa fa-phone" aria-hidden="true"></i>
									<a href="tel:<?php echo $row['com_did']?>"> <?php echo $row['com_did']?></a>
								</li>
							</ul>
